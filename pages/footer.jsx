    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <p className="text-sm font-semibold tracking-widest text-gray-400 uppercase">Address</p>
                ...
                <p className="text-base leading-relaxed text-gray-600 mt-2">Chennai (Head Office)</p>
                <p>1D, Kaashyap Enclave, New No.207, Old No.13A Velachery Main Road, Velachery, Chennai – 600042, India.</p>
            ...
            <div>
                ...
                <ul className="mt-6 space-y-4">
                    <li>
                        <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> IT Solutions </a>
                    </li>

                    <li>
                        <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> IT Services </a>
                    </li>

                    <li>
                        <a href="#" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Softwares </a>
                    </li>
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2025, All Rights Reserved by Techfruitspl</p>
    </div>
</section>
