...
const Testimonial = () => {
  ...
  return (
    <>
      ...
      <section className="pb-20 pt-20 dark:bg-dark lg:pb-[30px] lg:pt-[30px]">
     
      <h1 className="text-center  text-3xl font-extrabold py-8">Testimonials</h1>
        <div className="container mx-auto">
      
          <Swiper slidesPerView={1} ref={sliderRef}>
            <SwiperSlide>
              <SingleTestimonial
                image="https://techfruitspl.com/next-img/testimonial1.jpg"
               
                details="I am glad to write a testimonial for you.
 Working with Techfruits has been an outstanding experience. Their team provided us with customized IT infrastructure solutions that perfectly met our needs, showcasing their expertise and professionalism every step of the way.

Their exceptional customer service is second to none; they are always responsive and proactive in addressing our concerns. The reliability and performance of the solutions they provided have greatly enhanced our productivity.

I highly recommend Techfruits for their top-notch IT infrastructure sales and services. Their commitment to quality and customer satisfaction is truly commendable"
                name="Saji Nair"
                position="Head of IT, Rotomaker India Pvt. Ltd."
               
              />
            </SwiperSlide>
            <SwiperSlide>
              <SingleTestimonial
                image="https://techfruitspl.com/next-img/testimonial3.png"
               
                details="Dear Lenin, Techfruit Solutions has been the backbone of our enterprise IT Solutions support for 7+ years and still counting. They provide us end to end technology support with a wide range of hardware and software solutions. Be it centralized Storage, Software Purchase, Cyber security, Customized Workstation design, Techfruits have been out vendor over the years. They provide us industry best competitive pricing, extensive hardware support with quick turn around time during crisis management scenarios. We are very happy to be associated with Techfruits since they have got our backs round the clock all through the year."
                name="Thiru"
                position="Managing Director, Digital Film Restore Pvt. Limited"
              />
            </SwiperSlide>
            <SwiperSlide>
              <SingleTestimonial
                image="https://techfruitspl.com/next-img/testimonial2.png"
                details="Hi Lenin As the CEO of PhantomFX, I can confidently attest to the exceptional services provided by TechFruit. Over the past 8+ years, their unwavering commitment to supplying top-notch hardware, software, servers, and hard drives has been instrumental in our operations. Their continuous, reliable support has been invaluable, ensuring seamless functionality without encountering any issues.

TechFruit's dedication to providing the best prices, unparalleled support, and instant crisis management has surpassed our expectations. We are immensely pleased with our partnership and look forward to maintaining this fruitful association in the years to come."
                name="Ashwini C Sekar"
                position="Executive Assistant, PhantomFX "
              />
            </SwiperSlide>
        ...
        <div className="w-full items-center md:flex">
          ...
          <div className="w-full px-3">
            <div>
              ...
              <p className="testi-content mb-11 text-base font-normal italic leading-[1.81] text-body-color dark:text-dark-6 sm:text-[22px] text-justify">
                {details}
              </p>
